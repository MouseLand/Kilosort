...
ops.fbinary             = 'F:\DATA\Spikes\Diego\smallFile.dat'; % will be created for 'openEphys'
ops.fproc               = 'F:\DATA\Spikes\Diego\temp_wh.dat'; % residual from RAM of preprocessed data
ops.root                = 'F:\DATA\Spikes\Diego\'; % 'openEphys' only: where raw files are

ops.fs                  = 30000;        % sampling rate
% ops.NchanTOT            = 385;           % total number of channels
% ops.Nchan               = 344;           % number of active channels 
ops.Nfilt               = 512*3;           % number of filters to use (2-4 times more than Nchan, should be a multiple of 32)     
...
% ops.chanMap             = 'F:\DATA\Spikes\Diego\chanMap.mat'; % 'F:\DATA\Spikes\forPRBimecP3opt3.mat'; % make this file using createChannelMapFile.m
ops.chanMap             = 'G:\DATA\Spikes\neuropixPhase3A_kilosortChanMap.mat';
